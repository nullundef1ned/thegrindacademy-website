...
export default function Header() {
  ...
  return (
    <div className='border-b border-muted/10 w-full sticky top-0 bg-background/30 backdrop-blur-lg z-10'>
      <div className='flex items-center justify-between max-w-screen-2xl mx-auto root-padding p-4'>
        <Image src='/logos/logo.svg' alt='The Grind Academy Logo' width={188} height={188} />
